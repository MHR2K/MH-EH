...
class DownloadService : Service(), DownloadManager.DownloadListener {
    ...
    private val downloadsSceneClass = "com.hippo.ehviewer.ui.scene.download.DownloadsScene"
    private val downloadsSceneKeyAction = "action"
    private val downloadsSceneActionClearService = "clear_download_service"
    ...
    private fun ensureDownloadedBuilder() {
        ...
        val bundle = Bundle()
        bundle.putString(downloadsSceneKeyAction, downloadsSceneActionClearService)
        val activityIntent = Intent(this, MainActivity::class.java)
        activityIntent.setAction(StageActivity.ACTION_START_SCENE)
        activityIntent.putExtra(StageActivity.KEY_SCENE_NAME, downloadsSceneClass)
