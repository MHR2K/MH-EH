...
public class DownloadListInfosExecutor {
    ...
    public DownloadListInfosExecutor(@Nullable List<DownloadInfo> mList, String searchKey, boolean fuzzySearch, boolean caseSensitive) {
        this(mList, searchKey, fuzzySearch, caseSensitive, Settings.getEnableChineseConversion());
    }
    
    public DownloadListInfosExecutor(@Nullable List<DownloadInfo> mList, String searchKey, boolean fuzzySearch, boolean caseSensitive, boolean enableChineseConversion) {
        this.mList = mList;
        this.mSearchKey = searchKey;
    ...
    public void setSearchOptions(boolean fuzzySearch, boolean caseSensitive, boolean enableChineseConversion) {
        this.mFuzzySearch = fuzzySearch;
        this.mCaseSensitive = caseSensitive;
        this.mEnableChineseConversion = enableChineseConversion;
    }
    
    public void setSearchOptions(boolean fuzzySearch, boolean caseSensitive) {
        setSearchOptions(fuzzySearch, caseSensitive, Settings.getEnableChineseConversion());
    }
    ...
    private double calculateSimilarityScore(DownloadInfo info, String searchKey) {
        ...
        // 精确匹配给予最高分
        if ((!mCaseSensitive && fullTitle.toLowerCase().contains(searchKey.toLowerCase())) ||
            (mCaseSensitive && fullTitle.contains(searchKey))) {
        ...
        double similarityScore = EhUtils.calculateSimilarityScore(fullTitle, searchKey, 
                                                                 mFuzzySearch, mCaseSensitive, mEnableChineseConversion);
