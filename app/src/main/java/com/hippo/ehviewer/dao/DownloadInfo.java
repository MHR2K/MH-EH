...
public class DownloadInfo extends GalleryInfo {
	...
	public void updateInfo(GalleryInfo galleryInfo) {
		...
		this.simpleTags = galleryInfo.simpleTags;
		this.simpleLanguage = galleryInfo.simpleLanguage;
		this.pages = galleryInfo.pages;
	}

	public void updateInfoSelective(GalleryInfo source, Set<String> fields) {
		if (fields.contains("token")) this.token = source.token;
		if (fields.contains("title")) this.title = source.title;
		if (fields.contains("titleJpn")) this.titleJpn = source.titleJpn;
		if (fields.contains("thumb")) this.thumb = source.thumb;
		if (fields.contains("category")) this.category = source.category;
		if (fields.contains("posted")) this.posted = source.posted;
		if (fields.contains("uploader")) this.uploader = source.uploader;
		if (fields.contains("rating")) this.rating = source.rating;
		if (fields.contains("simpleTags")) this.simpleTags = source.simpleTags;
		if (fields.contains("simpleLanguage")) this.simpleLanguage = source.simpleLanguage;
		if (fields.contains("pages")) this.pages = source.pages;
	}
