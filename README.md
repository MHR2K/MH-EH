# 使用AI（Vsocde - Copilot）进行代码修改，方便日常使用
## 修改记录
 - 2025-12-02 : 同步 upstream 并 rebase
 - 2025-11-26 : 修改包名和应用名
 - 2025-11-24 : 编辑下载信息添加gid修改
 - 
 - 2025-11-18 : 支持读取smb路径的cbz文件
 - 2025-11-13 : 导入压缩包多选与 CBZ 支持改造说明
 - 2025-11-12 : 添加功能：仅删除图片文件（不移除下载项）、仅添加下载项
 - 2025-11-08 : 添加功能：支持将下载结果保存为CBZ并读取等
 - 2025-11-07 : 更新README
 - 
 - 2025-11-05 : 添加功能：在全部下载标签中搜索
 - 2025-11-05 : 添加功能：在下载列表快速搜索相同作者
 - 2025-10-29 : Smb_v4 (#1)：添加了SMB相关功能
 - 2025-10-01 : 添加功能：导入漫画(压缩包)到下载列表
 - 2025-09-30 : 修复了备份后下载列表标签排序丢失的问题
 - 
 - 2025-09-29 : 优化模糊搜索
 - 2025-09-25 : 修复实验性选项警告和弃用警告
 - 2025-09-25 : 修复从画廊详情页返回下载列表无法翻页的问题
 - 2025-09-25 : 添加功能：在画廊详情页能跳转到其在下载列表里对应的位置
 - 2025-09-25 : 添加功能：自动备份
 - 
 - 2025-09-22 : 修复滚动模式下阅读进度无法显示为最后一页的问题
 - 2025-09-13 : 添加功能：修改本地下载信息
 - 2025-09-13 : 添加功能：下载列表搜索增加选项“模糊搜索”和“区分大小写”
 - 2025-09-13 : 升级到 gradle 8.13
 - 2025-09-13 : 更新README
